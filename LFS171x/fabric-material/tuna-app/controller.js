...
return{
	...
	add_tuna: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'tuna-app',
		        fcn: 'recordTuna',
		        args: [key, clarity, color, cut, carat, certification, name, tx_id._transaction_id,holderName,timestamp,type, image,latitude,longitude],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	change_holder: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    var request = {
		        ...
		        args: [key, holder,tx_id._transaction_id,timestamp,type,latitude,longitude],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	update_location: function(req, res){
		console.log("changing location of tuna catch: ");

		var array = req.params.location.split("-");
		var key = array[0]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    var request = {
		        ...
		        chaincodeId: 'tuna-app',
		        fcn: 'updateLatLong',
		        args: [key,tx_id._transaction_id,timestamp,latitude,longitude],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
